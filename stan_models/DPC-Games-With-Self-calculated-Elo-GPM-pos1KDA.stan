...
model{
  for (i in 1:N_matches) {
    radiant_win[i] ~ bernoulli_logit(
      ...
      + b_radiant_pos5_GPM * radiant_pos5_GPM[i]
      + b_radiant_elo * radiant_elo[i]
      + b_dire_team_GPM * dire_team_GPM[i]
      + b_dire_pos5_GPM * dire_pos5_GPM[i]
